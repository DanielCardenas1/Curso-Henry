...
function agregarNumeros(numeros) {
  ...
  return suma;
  // variable suma en 0
  // For que recorra desde la primer posicion, que recorra todo
  // y lo incremente de a uno. Luego que acceda por notacion de corchetes
  // y se lo sume a lo que sea que tenga la variable en ese momento
  // al final que retorne lo que tenga la variable
}
